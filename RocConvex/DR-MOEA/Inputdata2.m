function [dataset,labelset,name,Rep] = Inputdata2(s)
...
%   此处显示详细说明
    ...
    switch s
       ...
       case 3
        ...
        case 13
            name = 'coil20';
            s = load([filepath,'data_large/coil20.mat']);
            dataset = (s.X)';
            labelset = (s.Y)';
        case 15
            name = 'madelon';
        ...
        case 14
            name = 'CNAE';
            dataset = load([filepath,'data_large/small/CNAE/CNAE.csv']);
            labelset = load([filepath,'data_large/small/CNAE/CNAE_label.csv']);
            dataset = dataset';
            labelset = labelset';
%         case 4
%             name = 'Malware';
