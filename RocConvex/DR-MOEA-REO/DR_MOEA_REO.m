...
%%在训练集和测试集上计算auc只值
        ...
        HV_train(rep) = hv_train/K;
        HV_test(rep) = hv_test/K;
        ...
        save([dirpath,'\','performance_HV_test.mat'],'performance_HV_test');
