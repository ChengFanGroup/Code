...
%         drawnow;       
   ...
   time4_noSR=etime(TIME2,TIME1);
%  time4 = cputime - T;              %runtime
 recordfit4_noSR=recordfit;
        s=new_f_x(F(1,:)==1,:);
%         subplot(2,4,1); 
...
Mbest_x_noSR=best_x;
Ms_noSR=s;
Mrecord_SAM_noSR =record_SAM; 
save MYEA_data_noSR Mbest_x_noSR Ms_noSR Mrecord_SAM_noSR  time4_noSR recordfit4_noSR
