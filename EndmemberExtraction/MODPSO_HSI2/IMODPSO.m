...
pop_num = 30;%number of particles  种群大小
maxiter = 200;%maximum number of iterations  最大迭代次数
...
%     legend('IMODPSO')
    ...
    scatter(f_GBA(:,1), f_GBA(:,2), 'Marker', 'v', 'MarkerEdgeColor', 'k', 'MarkerFaceColor', 'y');
xlabel('f1=1/V');
ylabel('f2=RMSE');
...
legend('IMODPSO');
   ...
   time2=etime(TIME2,TIME1)
%     time2 = cputime - T;              %runtime
    recordfit2=recordfit;
    [n,~] = size(GBA);
...
save IMODPSO_data result If_GBA f  Irecord_SAM time2 recordfit2  endmember
...
% subplot(2,4,2);
% legend('IMODPSO')
% plot(num,endmember1(:,SAM1(2,1)),'b.-','DisplayName','IMODPSO')
% 
%  hold on;
% subplot(2,4,3);
% legend('IMODPSO')
% plot(num,endmember1(:,SAM1(2,2)),'b.-','DisplayName','IMODPSO')
% 
%  hold on;
% subplot(2,4,4);
% legend('IMODPSO')
% plot(num,endmember1(:,SAM1(2,3)),'b.-','DisplayName','IMODPSO')
%  hold on;
% subplot(2,4,5); 
% legend('IMODPSO')
% plot(num,endmember1(:,SAM1(2,4)),'b.-','DisplayName','IMODPSO')
%  hold on;
% 
